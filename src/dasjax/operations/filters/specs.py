...
OPERATIONS: tuple[OperationSpec, ...] = (
    OperationSpec(
        ...
        patch_op_cls=impl.GaussianFilterOp,
    ...
    OperationSpec(
        ...
        patch_op_cls=impl.HampelFilterOp,
    ...
    OperationSpec(
        ...
        patch_op_cls=impl.PassFilterOp,
        ...
        test_cases=(
            OperationCase(
                ...
                resolve_call=lambda patch: (
                    (),
                    {patch.dims[-1]: (1.0, 10.0), "corners": 4, "zerophase": True},
                ),
            ...
            OperationCase(
                ...
                resolve_call=lambda patch: (
                    (),
                    {patch.dims[-1]: (None, 12.0), "corners": 2, "zerophase": False},
                ),
                prepare_patch=prepare_even_patch_for_dim,
                baseline=lambda patch, args, kwargs: baseline_patch_method(
                    patch, args, kwargs, "pass_filter"
